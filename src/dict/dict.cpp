...
Dict::Dict(CCUtil *ccutil)
    : letter_is_okay_(&tesseract::Dict::def_letter_is_okay),
      ...
      STRING_MEMBER(user_words_file, "", "A filename of user-provided words.",
                    getCCUtil()->params()),
      INIT_MEMBER(user_words_suffix, "",
                  "A suffix of user-provided words located in tessdata.",
                  getCCUtil()->params()),
      STRING_MEMBER(user_patterns_file, "",
                    "A filename of user-provided patterns.",
                    getCCUtil()->params()),
      INIT_MEMBER(user_patterns_suffix, "",
                  "A suffix of user-provided patterns located in "
                  "tessdata.",
                  getCCUtil()->params()),
      INIT_MEMBER(load_system_dawg, true, "Load system word dawg.",
                  getCCUtil()->params()),
      INIT_MEMBER(load_freq_dawg, true, "Load frequent word dawg.",
                  getCCUtil()->params()),
      INIT_MEMBER(load_unambig_dawg, true, "Load unambiguous word dawg.",
                  getCCUtil()->params()),
      INIT_MEMBER(load_punc_dawg, true, "Load dawg with punctuation patterns.",
                  getCCUtil()->params()),
      INIT_MEMBER(load_number_dawg, true, "Load dawg with number patterns.",
                       getCCUtil()->params()),
      INIT_MEMBER(load_bigram_dawg, true,
