...
class FullyConnected : public Network {
 public:
  ...
  void ForwardTimeStepFloat(int t, float* output_line);
  ...
  void ForwardTimeStepFloat(const int8_t* i_input, int t, float* output_line);
  void ForwardTimeStepFloat(const float* d_input, int t, float* output_line);
