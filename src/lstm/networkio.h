...
class NetworkIO {
 public:
  ...
  void ReadTimeStepFloat(int t, float* output) const;
  ...
  void WriteTimeStepFloat(int t, const float* input);
  ...
  void WriteTimeStepPart(int t, int offset, int num_features,
                         const double* input);
  void WriteTimeStepPartFloat(int t, int offset, int num_features,
                              const float* input);
